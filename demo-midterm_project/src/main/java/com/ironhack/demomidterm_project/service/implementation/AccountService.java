...
public class AccountService implements AccountServiceInterface {
    ...
    public void sendMoney(ThirdPartyTransferDTO thirdPartyTransferDTO) {
        ...
        if (thirdPartyRepository.findByHashedKey(thirdPartyTransferDTO.getHashedKey()) == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Wrong hashed key.");
        }
